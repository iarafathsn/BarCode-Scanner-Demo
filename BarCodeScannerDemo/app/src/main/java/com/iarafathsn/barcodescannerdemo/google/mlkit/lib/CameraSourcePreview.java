...
package com.iarafathsn.barcodescannerdemo.google.mlkit.lib;
...
public class CameraSourcePreview extends ViewGroup {
    ...
    private void start(CameraSource cameraSource) throws IOException {
        ...
        if (this.cameraSource != null) {
            Log.i(TAG, "Starting.. cameraSource is null");
            startRequested = true;
            startIfReady();
        }
    ...
    public void start(CameraSource cameraSource, GraphicOverlay overlay) throws IOException {
        Log.i(TAG, "Starting with overlay..");
    ...
    private void startIfReady() throws IOException, SecurityException {
        Log.i(TAG, "startIfReady called..");
        if (startRequested && surfaceAvailable) {
            cameraSource.start();
            Log.i(TAG, "startIfReady start called..");
